  ...
  return (
    <div className="bg-[#DBDBDB] z-50 py-6 px-3 lg:py-12 lg:px-6">
      ...
      <div className="relative m-auto z-50 shadow-md grid grid-cols-2 gap-2 md:grid-cols-4 w-[80%] bg-white rounded-md py-12 px-4">
        <div className="text-center p-2 md:border-b-0 border-b-2 md:border-r-2 hover:text-orange border-[#797979]">
        <AnimatedNumbers
        includeComma
        animateToNumber={860}
      ...
      ></AnimatedNumbers>
        ...
        <div className="text-center p-2 md:border-r-2 md:border-b-0 hover:text-orange border-b-2 border-[#797979]">
        <AnimatedNumbers
        includeComma
        animateToNumber={50}
        fontStyle={{ fontSize: 40 }}
      ...
      ></AnimatedNumbers>
        ...
        <div className="text-center hover:text-orange p-2 md:border-r-2 border-[#797979]">
        <AnimatedNumbers
        includeComma
        animateToNumber={93}
        fontStyle={{ fontSize: 40 }}
      ...
      ></AnimatedNumbers>
        ...
        <div className="text-center hover:text-orange">
      ...
      ></AnimatedNumbers>
        ...
        <div className="ball z-2 absolute left-0 bottom-1 rounded-full h-12 w-12">
