...
const ChatBox = () => {
  return (
    <div className='m-auto flex flex-col md:flex-row pb-20 md:pb-36 2xl:pb-40   w-[85%] 2xl:w-[65%]'>
        <div className='bg-black flex-1  text-white py-12 2xl:px-16 2xl:py-16 rounded-md
        px-12 space-y-8'>
        ...
        <div className='flex-1  2xl:max-w-[500px] md:relative md:mt-4 md:mb-4 bg-orange'>
                ...
                <Image
                    ...
                    src={image1}
                    alt=""
                    className='md:absolute top-8 rounded-md -left-[2%]'
                />
